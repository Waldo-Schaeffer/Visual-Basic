...
Public ExitState As Boolean
Public ProgressMax As Double
...
'--------数组解密全局函数--------
Public Function JXDecrypt(GetByteArray() As Byte, ByRef PutByteArray() As Byte, Optional EventState As Boolean = False) As Boolean
...
'--------数组加密全局函数--------
Public Function JXEncrypt(GetByteArray() As Byte, ByRef PutByteArray() As Byte, Optional EventState As Boolean = False) As Boolean
